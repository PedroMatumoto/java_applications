...
public class Checksum {
    ...
    public static void main(String[] args) {
        ...
        String[] arquivosText = leChardeTXT("aula20/entrada.txt");
        // converter as strings para char
        char[] palavras = StringArraytoCharArray(arquivosText);
        String palavrainvertida = "";
        for(int i = palavras.length-1; i >= 0; i--){
            palavrainvertida += palavras[i];
        }
        escreverSomaEmTxt(palavrainvertida, "aula20/saida.txt");
        char [] palavrainvertidachar = palavrainvertida.toCharArray();
        String saida = calculaComplemento2(palavras);
        System.out.println("\n");
        System.out.print("Resultado entrada: "+saida);
        System.out.println("\n");
         String saida2 = calculaComplemento2(palavrainvertidachar);
        System.out.print("\nResultado saida: "+saida2);
