...
public class Checksum {
    ...
    public static String CRC(String bits){
        String divisor = "1011";
        // transformar em binario
        int divisorbin = Integer.parseInt(bits, 2) / Integer.parseInt(divisor, 2);
        System.out.println(divisorbin);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\n ===== Ler de txt =====");
        String[] teste2 = leChardeTXT("entrada.txt");
